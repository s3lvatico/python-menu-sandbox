...
menu = MenuItem('Main Menu', CTG_SUBMENU, None, [
    MenuItem('Greetings', CTG_SUBMENU, None, [
        ...
        MenuItem('GoodbyTe', CTG_COMMAND, None,
                 [], functions.commiato_semplice),
        MenuItem('Italian slurs', CTG_SUBMENU, None, [
            MenuItem('Fagiano', CTG_COMMAND, None, [],
                     functions.saluto_insulto_fagiano),
            MenuItem('Maiale', CTG_COMMAND, 'M', [],
                     functions.saluto_insulto_maiale),
            MenuItem('Tacchino', CTG_COMMAND, 'T', [],
                     functions.saluto_insulto_tacchino)
        ], None),
    ], None),
